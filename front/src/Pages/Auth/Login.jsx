...
import { Heading, Input, Button, FormControl, Stack, Box, InputRightElement, InputGroup, FormLabel, Container,
...
const Login = () => {
  ...
  return    <Layout>
              <Container maxW="500px" bg="white" py="39px" px={["16px","","","40px"]} m="0 auto" borderRadius="4px">
                <Stack spacing={8} mx={'auto'} p="12px 6px" minH="100vh" justifyContent="center" alignItems="center">
                  <Stack align={'center'}>
                    <Heading fontSize={'4xl'}> Sign In </Heading>
                  </Stack>
        
                  <Box rounded={'lg'} bg={useColorModeValue('white', 'gray.700')} boxShadow={'lg'} p={8} w="100%">
                    <Stack spacing={4}>
